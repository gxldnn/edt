...
CREATE TABLE assumpteXprocurador (
  ...
  CONSTRAINT assumpteXprocurador_dniprocurador_fk FOREIGN KEY (dniprocurador) REFERENCES procurador(dniprocurador) ON DELETE   -- Referència a la taula `procurador`
);
