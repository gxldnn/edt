...
<html lang="ca-ES">
  ...
  <body> 
    ...
    <h1>Factura</h1>
    <table>
      <tr><th>Article</th><th>Quantitat</th><th>Preu</th><th>Subtotal</th><th>Descompte</th><th>Iva 21%</th><th>Total</th></tr>      
        <?php 
            $tcant = 0;
            $tnoiva = 0;
            $tiva = 0;
           ...
           for ($x = 1; $x < mt_rand(10,19); $x++){
             ...
             echo "</tr><td>Article $x</td><td>$quantitat</td><td>".$preu."€</td><td>".$subtotal."€</td><td>$descompte% (-".$preudescomptat."€)</td><td>". round($ivares, 2)."€</td><td>". round($total, 2) ."€</td></tr>";
