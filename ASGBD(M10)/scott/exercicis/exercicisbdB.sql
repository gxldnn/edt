...
SELECT r.nombre "Nom Repv", o.ciudad"Ciutat", p.pednum"Numero de comanda", p.importe "Import" , pr.descrip "Producto"
FROM repventa r
LEFT JOIN oficina o ON r.ofinum = o.ofinum
JOIN pedido p ON r.repcod = p.repcod
RIGHT JOIN producto pr ON p.fabcod||p.prodcod = pr.fabcod||pr.prodcod
ORDER BY 1;
