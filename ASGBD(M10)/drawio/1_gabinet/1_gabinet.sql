...
CREATE TABLE assumpteXprocurador (
  ...
  CONSTRAINT assumpteXprocurador_dniprocurador_fk FOREIGN KEY (dniprocurador) REFERENCES procurador(dniprocurador) ON DELETE CASCADE ON UPDATE CASCAS -- Referència a la taula `procurador`
);
