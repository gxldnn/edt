...
Primerament inserim un registre amb `ID = 30, valor = 5`, començem la transacció, es canvia el camp valor per `4` on el ID = 30, es fa un SAVEP, es a dir, es guarden els canvis, despres es fa un select, que donarà 4
```
